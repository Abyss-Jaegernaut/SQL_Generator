# Script to create the hardware_id module
...
with open('d:/SQL_GENERATOR/utils/hardware_id.py', 'w', encoding='utf-8') as f:
    f.write(content)

print('Hardware ID module created successfully')